export default function NeoLiberalismText() {
    return (
      <div className="flex items-center justify-center h-screen">
        <h1 className="relative w-[max-content] font-mono flex items-center justify-center font-bold text-center text-4xl text-slate-950
